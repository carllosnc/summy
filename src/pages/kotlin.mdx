...
- [Coroutines - suspending functions](#coroutines---suspending-functions)
- [Coroutines - scopes](#coroutines---scopes)
...
println(calc.div(1, 2))
```
- [👉 Object extension](https://kotlinlang.org/docs/extensions.html)
