...
- <a href="#anonymous-class">Anonymous class</a>
...
```
[👉 Attributes in PHP 8](https://php.watch/articles/php-attributes#intro-naming)
...
Color::Blue->printColor(); //🥶 Color: Blue
Color::Purple->printColor(); //👿 Color: Purple
```
