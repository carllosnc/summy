...
int main()
{
  ...
  std::cout << monday << std::endl; // 2 - tuesday
...
public:
  ...
  Hero(std::string name, int age, int level) : Person(name, age)
  {
    this->level = level;
  }
};
...
int main()
{
  ...
  std::cout << hero.age << std::endl;
  std::cout << hero.level << std::endl;
...
{
  std::cout << "An exception occurred. Exception unknown" << '\n';
}
